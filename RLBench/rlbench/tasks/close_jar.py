...
from rlbench.backend.conditions import NothingGrasped, DetectedCondition, ConditionSet, GraspedCondition
...
class CloseJar(Task):
    ...
    def init_episode(self, index: int) -> List[str]:
        ...
        # success_condition = ConditionSet([GraspedCondition(self.robot.gripper, self.lid)])
        # self.register_success_conditions([success_condition])
        
        self.register_success_conditions([DetectedCondition(self.lid, success)]) # https://github.com/MohitShridhar/RLBench/pull/1
